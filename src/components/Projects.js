		...
		<section id="projects">
            ...
            <div className="projectContainer" id="wProject">
				<div className="imageContainer">
					<a href="https://repcalc.net/example" target="_blank" rel="noopener noreferrer">
                ...
                <div className="descContainer">
                    ...
                    <a className="button" href="https://repcalc.net/example" target="_blank" rel="noopener noreferrer">View Project <i className="fas fa-chevron-right"></i></a>
                </div>
            </div>

            <div className="projectContainer" id="hProject">
				<div className="imageContainer">
					<a href="https://allygator.github.io/HeroRotation/" target="_blank" rel="noopener noreferrer">
                ...
                <div className="descContainer">
                    ...
                    <a className="button" href="https://allygator.github.io/HeroRotation/" target="_blank" rel="noopener noreferrer">View Project <i className="fas fa-chevron-right"></i></a>
                </div>
            </div>

            <div className="projectContainer" id="sProject">
                <div className="imageContainer">
                    <a href="https://allygator.github.io/StardewValley/" target="_blank" rel="noopener noreferrer">
                ...
                <div className="descContainer">
                    ...
                    <a className="button" href="https://allygator.github.io/StardewValley/" target="_blank" rel="noopener noreferrer">View Project <i className="fas fa-chevron-right"></i></a>
                </div>
            </div>
		</section>
	);
